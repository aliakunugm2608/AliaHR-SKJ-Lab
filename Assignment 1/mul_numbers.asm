...
mul_numbers:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c3:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    11ca:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11cd:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    11d1:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11d4:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11d7:	89 c6                	mov    %eax,%esi
    11d9:	48 8d 05 60 2e 00 00 	lea    0x2e60(%rip),%rax        # 4040 <_ZSt4cout@GLIBCXX_3.4>
    11e0:	48 89 c7             	mov    %rax,%rdi
    11e3:	e8 c8 fe ff ff       	call   10b0 <_ZNSolsEi@plt>
    11e8:	48 8b 15 e1 2d 00 00 	mov    0x2de1(%rip),%rdx        # 3fd0 <_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_@GLIBCXX_3.4>
    11ef:	48 89 d6             	mov    %rdx,%rsi
    11f2:	48 89 c7             	mov    %rax,%rdi
    11f5:	e8 96 fe ff ff       	call   1090 <_ZNSolsEPFRSoS_E@plt>
    11fa:	b8 00 00 00 00       	mov    $0x0,%eax
    11ff:	c9                   	leave  
    1200:	c3                   	ret    

0000000000001201 <_Z41__static_initialization_and_destruction_0ii>:
    1201:	f3 0f 1e fa          	endbr64 
    1205:	55                   	push   %rbp
    1206:	48 89 e5             	mov    %rsp,%rbp
    1209:	48 83 ec 10          	sub    $0x10,%rsp
    120d:	89 7d fc             	mov    %edi,-0x4(%rbp)
    1210:	89 75 f8             	mov    %esi,-0x8(%rbp)
    1213:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    1217:	75 3b                	jne    1254 <_Z41__static_initialization_and_destruction_0ii+0x53>
    1219:	81 7d f8 ff ff 00 00 	cmpl   $0xffff,-0x8(%rbp)
    1220:	75 32                	jne    1254 <_Z41__static_initialization_and_destruction_0ii+0x53>
    1222:	48 8d 05 28 2f 00 00 	lea    0x2f28(%rip),%rax        # 4151 <_ZStL8__ioinit>
    1229:	48 89 c7             	mov    %rax,%rdi
    122c:	e8 6f fe ff ff       	call   10a0 <_ZNSt8ios_base4InitC1Ev@plt>
    1231:	48 8d 05 d0 2d 00 00 	lea    0x2dd0(%rip),%rax        # 4008 <__dso_handle>
    1238:	48 89 c2             	mov    %rax,%rdx
    123b:	48 8d 05 0f 2f 00 00 	lea    0x2f0f(%rip),%rax        # 4151 <_ZStL8__ioinit>
    1242:	48 89 c6             	mov    %rax,%rsi
    1245:	48 8b 05 ac 2d 00 00 	mov    0x2dac(%rip),%rax        # 3ff8 <_ZNSt8ios_base4InitD1Ev@GLIBCXX_3.4>
    124c:	48 89 c7             	mov    %rax,%rdi
    124f:	e8 2c fe ff ff       	call   1080 <__cxa_atexit@plt>
    1254:	90                   	nop
    1255:	c9                   	leave  
    1256:	c3                   	ret    

0000000000001257 <_GLOBAL__sub_I_main>:
    1257:	f3 0f 1e fa          	endbr64 
    125b:	55                   	push   %rbp
    125c:	48 89 e5             	mov    %rsp,%rbp
    125f:	be ff ff 00 00       	mov    $0xffff,%esi
    1264:	bf 01 00 00 00       	mov    $0x1,%edi
    1269:	e8 93 ff ff ff       	call   1201 <_Z41__static_initialization_and_destruction_0ii>
    126e:	5d                   	pop    %rbp
    126f:	c3                   	ret    
